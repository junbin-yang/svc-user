    ...
    <div class="gva-card-box">
      <div class="gva-card gva-top-card">
        <div class="gva-top-card-left">
          ...
          <div class="gva-top-card-left-dot"><br></div>
          ...
          <div>
            <div class="gva-top-card-left-item">
              用户注册：
              <el-button color="#626aef" plain @click="submitInvitationCode">生成邀请码</el-button>
            </div>
          </div>
        </div>
...
import { GegSystemInfo, getInvitationCode } from '@/api/user'
...
const submitInvitationCode = async() => {
  ...
  if (res.code === 200) {
    ...
    ElMessageBox.alert(res.data, '邀请码')
  } else {
    ElMessage({
      type: 'error',
      message: res.message,
