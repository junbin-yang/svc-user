    ...
    <div id="userLayout">
        <div class="login_panle">
            <div class="login_panle_form">
                ...
                <!-- 登录表单 -->
                <el-form v-if="pageType==='login'" ref="loginForm" :model="loginFormData" :rules="rules" @keyup.enter="submitForm">
                    ...
                    <el-form-item prop="validateCode">
                        <div class="vPicBox">
                            <el-input v-model="loginFormData.validateCode" placeholder="请输入验证码" style="width: 60%" />
                            <div class="vPic">
                ...
                <!-- 注册表单 -->
                <el-form v-if="pageType==='registerUser'" ref="registerForm" :model="registerFormData" :rules="registerRules" label-width="80px">
                    <el-form-item label="邀请码" prop="invitationCode">
                        <el-input v-model="registerFormData.invitationCode" placeholder="请输入邀请码" clearable />
                    </el-form-item>
                    <el-form-item label="账号" prop="account">
                        <el-input v-model="registerFormData.account" placeholder="请输入账号" clearable />
                    </el-form-item>
                    <el-form-item label="密码" prop="password">
                        <el-input v-model="registerFormData.password" :type="lock === 'lock' ? 'password' : 'text'" placeholder="请输入密码" clearable />
                    </el-form-item>
                    <el-form-item label="确认密码" prop="password_ck">
                        <el-input v-model="registerFormData.password_ck" :type="lock === 'lock' ? 'password' : 'text'" placeholder="请再次输入密码" clearable />
                    </el-form-item>
                    <el-form-item label="用户昵称" prop="nickName">
                        <el-input v-model="registerFormData.nickName" placeholder="请输入昵称" clearable />
                    </el-form-item>
                    <el-form-item label="手机号" prop="mobile">
                        <el-input v-model="registerFormData.mobile" placeholder="请输入手机号" clearable />
                    </el-form-item>
                    <el-form-item label="邮箱地址" prop="email">
                        <el-input v-model="registerFormData.email" placeholder="请输入邮箱地址" clearable />
                    </el-form-item>
                    <el-form-item label="验证码" prop="validateCode">
                        <el-input v-model="registerFormData.validateCode" placeholder="请输入邮箱验证码" style="width: 46%" clearable />
                        <el-button size="large" style="width: 46%;margin-left: 8%" type="success" :class="{gray:wait_timer>0}" :disabled="validateCodeButtonStatus" @click="getCode()">
                            <span v-show="showNum" :class="{num:wait_timer>0}">{{ wait_timer + "s" }}</span>
                            <span :class="{gray_span:wait_timer>0}">{{ getCodeText() }}</span>
                        </el-button>
                    </el-form-item>
                    <el-form-item>
                ...
                <!-- 找回密码表单 -->
                <el-form v-if="pageType==='retrievePass'" ref="retrievePasswordForm" :model="retrievePasswordFormData" :rules="retrievePasswordRules" label-width="80px">
                    <el-form-item label="邮箱地址" prop="email">
                        <el-input v-model="retrievePasswordFormData.email" placeholder="请输入邮箱地址" clearable />
                    </el-form-item>
                    <el-form-item label="密码" prop="password">
                        <el-input v-model="retrievePasswordFormData.password" :type="lock === 'lock' ? 'password' : 'text'" placeholder="请输入新密码" clearable />
                    </el-form-item>
                    <el-form-item label="确认密码" prop="password_ck">
                        <el-input v-model="retrievePasswordFormData.password_ck" :type="lock === 'lock' ? 'password' : 'text'" placeholder="请再次输新入密码" clearable />
                    </el-form-item>

                    <el-form-item label="验证码" prop="validateCode">
                        <el-input v-model="retrievePasswordFormData.validateCode" placeholder="请输入邮箱验证码" style="width: 46%" clearable />
                        <el-button size="large" style="width: 46%;margin-left: 8%" type="success" :class="{gray:wait_timer>0}" :disabled="validateCodeButtonStatus" @click="getCode()">
                            <span v-show="showNum" :class="{num:wait_timer>0}">{{ wait_timer + "s" }}</span>
                            <span :class="{gray_span:wait_timer>0}">{{ getCodeText() }}</span>
                        </el-button>
