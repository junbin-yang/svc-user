              ...
              <ul>
                ...
                >
                  <li>
                    ...
                    {{ userStore.userInfo.realname ? userStore.userInfo.realname : userStore.userInfo.nickname }}
                  </li>
                </el-tooltip>
                <el-tooltip
                  class="item"
                ...
                >
                  <li>
                    ...
                    {{ userStore.userInfo.age? userStore.userInfo.age : "-" }}
                  </li>
                </el-tooltip>
                <el-tooltip
                  class="item"
                ...
                >
                  <li>
                    ...
                    {{ userStore.userInfo.nation? userStore.userInfo.nation : "-" }}
                  </li>
                </el-tooltip>
                <el-tooltip
                  class="item"
                ...
                >
                  <li>
                    ...
                    {{ userStore.userInfo.address? userStore.userInfo.address : "-" }}
                  </li>
                </el-tooltip>
              </ul>
            </div>
            ...
            <el-tab-pane label="账号绑定" name="second">
              <ul>
                <li v-show="false">
                  ...
                  <p class="desc">
                    已绑定手机:{{ userStore.userInfo.mobile }}
    ...
    >
      ...
      >
        ...
        <el-form-item label="验证码" prop="validateCode">
          <div class="vPicBox">
            <el-input
              v-model="pwdModify.validateCode"
              style="width: 60%"
              placeholder="请输入验证码"
              show-password
            />
...
const savePassword = async() => {
  modifyPwdForm.value.validate((valid) => {
    if (valid) {
      changePassword({
        password: md5(pwdModify.value.password),
        newPassword: md5(pwdModify.value.newPassword),
        validateCodeId: pwdModify.value.validateCodeId,
        validateCode: pwdModify.value.validateCode
      }).then((res) => {
        if (res.code === 200) {
...
const getVerify = () => {
  captcha({}).then((ele) => {
    ...
    pwdModify.value.validateCodeId = ele.data.key
  })
}
getVerify()
