...
/**
 * Generated from protobuf message <code>proto.MenusRequest.MenusNode</code>
 */
class MenusNode extends \Google\Protobuf\Internal\Message
{
     ...
     * 下级节点
     *
     * Generated from protobuf field <code>repeated .proto.MenusRequest.MenusNode Children = 7;</code>
     */
    private $Children;
    /**
     * 备注
     ...
     *           授权动作
     *     @type \Proto\MenusRequest\MenusNode[]|\Google\Protobuf\Internal\RepeatedField $Children
     *           下级节点
     *     @type string $Remark
     *           备注
     *     @type bool $Status
...
class_alias(MenusNode::class, \Proto\MenusRequest_MenusNode::class);
